    ...
    <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav class="hidden items-center gap-7 text-[13px] font-bold uppercase tracking-[0.16em] text-white/75 lg:flex">
            ...
            <a
                ...
                class="relative py-6 transition
                {{ request()->routeIs('home')
                    ? 'text-white after:absolute after:inset-x-0 after:bottom-4 after:h-0.5 after:bg-tsm-yellow'
            ...
            <a
                href="{{ route('home') }}#accessoires"
                class="relative py-6 transition
                {{ request()->routeIs('accessoires.*')
                    ? 'text-white after:absolute after:inset-x-0 after:bottom-4 after:h-0.5 after:bg-tsm-yellow'
                    : 'hover:text-tsm-yellow'
                }}">
                Accessoires
        ...
        <div class="flex items-center gap-3">
            ...
            <a
                href="{{ route('contact.create') }}"
                class="hidden rounded-full bg-tsm-yellow px-5 py-2.5 text-sm font-extrabold uppercase tracking-wide text-tsm-dark shadow-lg shadow-tsm-yellow/20 transition hover:bg-tsm-gold md:inline-flex">
                Réserver un essai
            </a>
